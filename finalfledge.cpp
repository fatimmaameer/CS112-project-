    ...
    while (continueBuilding) {
        ...
        switch (choice) {
            case 1: {
                ...
                ecoPoints += 10;
                numberOfBuildings++;  // Increment building count
                cout << GREEN << "+10 points for Rainwater Harvesting System.\n" << RESET;
                cout << GREEN << "Total buildings now: " << numberOfBuildings << "\n" << RESET;
                break;
            }
            case 2: {
...
void mayorPanel() {
    // Create zone objects ONCE at the beginning
    static IndustrialZone IZ;
    static ResidentialZone RZ;
    static CommercialZone CZ;
    static TransportZone TZ;
    ...
    while (true) {
        ...
        // Stay in action selection until user chooses to go back
        bool return_to_zone_selection = false;
        while (!return_to_zone_selection) {
            // action selection
            clearScreen();
            ...
            while (!action_selected) {
                ...
                cout << RED << (action_choice == 5 ? "> " : "  ") << "5. Back to zone selection\n";
            ...
            if (action_choice != 5) {
                cout << "\n\n" << CYAN << "Action completed. Press any key to continue managing this zone..." << RESET;
                getch();
            }
        }
    }
